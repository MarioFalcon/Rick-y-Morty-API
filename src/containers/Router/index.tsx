  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="login" element={<HandleSession><Login onLogin={onLogin} /></HandleSession>}></Route>
        <Route path="signup" element={<HandleSession><Signup onSignup={onSignup} /></HandleSession>}></Route>
